...
class UnitLib(object):
    ...
    def initialize(cls):
        ...
        cur.execute(
            ...
            eff_c_tome, eff_c_staff, eff_r_breath, eff_b_breath, eff_g_breath,
            ...
            r_tome, b_tome, g_tome, c_tome, c_staff, r_breath, b_breath,
            g_breath, c_breath, r_beast, b_beast, g_beast, c_beast, refinable,
