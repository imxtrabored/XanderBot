...
from command.common import format_hero_title, process_hero
...
class HeroMerges(CmdDefault):
    ...
    help_text = (
        'The ``merges`` command shows a quick summary of the attribute bonuses '
        'from merging extra copies of a hero.\n\n'
        'Usage: ``f?merges {hero name}, {modifier 1}, {modiier 2}, {additional '
        'modifiers...}``\n'
    )
